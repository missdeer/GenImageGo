...
func InitDB(dbType, dsn string) (*gorm.DB, error) {
	...
	if err := db.AutoMigrate(&User{}, &Session{}, &PasswordResetToken{}, &EmailVerificationToken{}, &Organization{}, &Membership{}, &IdempotencyKey{}, &PointTransaction{}, &SiteConfig{}); err != nil {
